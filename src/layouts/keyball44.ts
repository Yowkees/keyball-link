...
// ファームウェアでは row0-3=物理左半分, row4-7=物理右半分
// LAYOUT_no_ball は L**→row0-3(物理左), R**→row4-7(物理右) に配置する
...
export const keyball44Layout: KeyLayout[] = [
  ...
  { id: 'L32', row: 3, col: 2, x:  2, y: 3, ball: 'left' },
  { id: 'L33', row: 3, col: 3, x:  3, y: 3, ball: 'left' },
  { id: 'L34', row: 3, col: 4, x:  4, y: 3 },
  { id: 'L35', row: 3, col: 5, x:  5, y: 3 },
  { id: 'R35', row: 7, col: 5, x:  7, y: 3 },
  { id: 'R34', row: 7, col: 4, x:  8, y: 3 },
